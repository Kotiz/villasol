<template>
  <div :class="`useable-tools-section-two bg-shape ${feature? 'mb-250 mt-150 md-mt-100 md-mb-100' : 'mb-200 mt-150 md-mt-50 md-mb-120'} `">
        ...
        <div class="title-style-two text-center mb-70 md-mb-10">
          <div class="row">
            <div class="col-lg-10 col-md-11 m-auto">
              ...
              <a href="#" class="theme-btn-two mt-60 md-mt-40">Try out now</a>
            </div>
          </div>
        </div> <!-- /.title-style-two -->
